"""mediku_29462 URL Configuration
...
admin.site.site_header = "Mediku"
admin.site.site_title = "Mediku Admin Portal"
admin.site.index_title = "Mediku Admin"

# swagger
api_info = openapi.Info(
    title="Mediku API",
    default_version="v1",
    description="API documentation for Mediku App",
)
